function [] = variableVerticalLoad_Mz_N(x)
global File_tir_R20;
global File_tir_LC0;
global Norm_x;
global Norm_y_Mz;
...
Fz = input(prompt);
prompt ="insert the  first value of the pneumatic trail ";
p = input(prompt);
...
switch file
    case 1
        ...
        figure
        plot((C*Norm_x)/Fz,-Mz/(Norm_y_Mz*Fz*p))
        ...
        for i=1:x-1
            ...
            Fz = input(prompt);
            prompt ="insert the new value of the pneumatic trail ";
            p = input(prompt);
